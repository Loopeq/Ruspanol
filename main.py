...
from domain.user_section.edit_user_section import edit_user_section, finish_edit_user_section
...
async def start():
    ...
    dp.callback_query.register(edit_user_section, UserSectionsCD.filter(F.action=="edit_us"))
